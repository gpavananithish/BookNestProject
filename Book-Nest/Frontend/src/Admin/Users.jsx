                    ...
                    {showDetails && (
                      <div className="fixed top-0 left-0 w-screen h-screen flex items-center justify-center z-50">
                        ...
                        <div
                          ...
                          style={{ maxHeight: '80vh', overflowY: 'scroll', backgroundColor: isDarkMode ? '#133944' : 'white', color: isDarkMode ? 'white' : 'black' }}
                        >
                          <p className="text-sm text-gray-600">
                            <div className="container mx-auto mt-8" style={{ width: '1350px' }}>
                              <h1 className="text-center text-blue-300" style={{ color: isDarkMode ? 'white' : 'darkcyan' }}>User Orders</h1>
